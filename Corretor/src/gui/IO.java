...
public class IO extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(campoCep1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.linkSize(new java.awt.Component[] {jScrollPane1, jScrollPane4}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(btnRemover)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(campoCep1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.linkSize(new java.awt.Component[] {jScrollPane1, jScrollPane4}, org.jdesktop.layout.GroupLayout.VERTICAL);
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        .add(btnCancelar)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 642, Short.MAX_VALUE)
                        .add(btnSalvar)))
                .addContainerGap())
        );
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            int opcao = JOptionPane.showConfirmDialog(null, "Alterando o número de questões você " +
                    "perderá todas as alterações anteriores!\n Você tem certeza?", "Confirmação!", JOptionPane.YES_NO_OPTION);
            if (opcao == 0) {
                int numeroQuestoes = Integer.parseInt(txtNroQuestoes.getText());
                if (numeroQuestoes > 0) {
                    GerenciaIO gerencia = new GerenciaIO(pastaCorrecao);
                    listaQuestoes.setListData(gerencia.setVetorQuestões(numeroQuestoes));
                    listaQuestoes.setSelectedIndex(0);
    ...
    private gui.CampoCep campoCep1;
